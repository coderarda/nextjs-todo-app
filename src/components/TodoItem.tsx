...
export function TodoItem({ title }: { title: string }) {
    return (
        <li className="inline-flex flex-row p-2 m-2 justify-start rounded items-center bg-slate-500">
            <div className="rounded-sm h-5 aspect-square flex flex-row justify-center bg-slate-400">
